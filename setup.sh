...
linked=0
for agent_src in "$FRAMEWORK_DIR/agents/"*.md; do
...
linked_skills=0
for skill_src in "$FRAMEWORK_DIR/skills/"*/; do
...
echo "  4. Copy a template from $rel_framework/memory/templates/ into any subdirectory"
